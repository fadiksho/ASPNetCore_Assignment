...
addPersonSucceeded = function addPersonSucceeded(xhr) {
  addNewPersonForm.find("input[type=text]").val("");
};

updatePersonSucceeded = function updatePersonSucceeded() {
  toggleEditFormVisibility(false);
...
deletePersonSucceeded = function deletePersonSucceeded(rowId) {
  $("#".concat(rowId)).hide('slow');
};
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
